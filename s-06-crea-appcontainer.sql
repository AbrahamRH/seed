...
CREATE TABLE admin_centro_app.CENTRO_ACOPIO
(
...
CREATE UNIQUE INDEX XPKCENTRO_ACOPIO ON admin_centro_app.CENTRO_ACOPIO
...
INSERT INTO admin_centro_app.centros_acopio (centro_acopio_id, nombre_centro, direccion_centro, latitud_centro, longitud_centro, empleado_id)
VALUES 
